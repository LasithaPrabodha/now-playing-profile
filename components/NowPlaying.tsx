...
export const Player: React.FC<Props> = ({ cover, track, artist, progress, duration, isPlaying, isLastPlayed }) => {
  return (
    <ReadmeImg width={artist ? 430: 360} height="85">
      ...
      <div style={{ display: "flex", flexDirection: "row", alignItems: "center", paddingLeft: "4px", paddingBottom: "2px" }}>
        ...
        <Text id="nowplaying">
          {artist ? (isLastPlayed ? "Last song I played..." : "The song I'm spinning right now...") : "I'm taking a break from music for now. \nIf I'm spinning something, it'll be back up here."}
        </Text>
      </div>
      {artist && <div
